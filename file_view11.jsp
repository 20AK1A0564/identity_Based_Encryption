...
<td bgcolor="#CCFFFF"> <a href="ownerfileview.jsp?file_name=<%=file_name%>">view</a> </td>
...
<td bgcolor="#CCFFFF"> <a href="view12345.jsp?file_name=<%=file_name%>">view</a> </td>           

<td bgcolor="#CCFFFF"> <font color="red"><b><blink><a href="requestowner.jsp?file_name=<%=file_name%>&ownerid=<%=userid%>" >Req PKGkey</a>
 | 
