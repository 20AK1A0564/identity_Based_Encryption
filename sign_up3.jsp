...
System.out.println(" after class.forName1");

Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/service","root","root");
System.out.println(" after conneftion");

uid="18";
PreparedStatement ps=con.prepareStatement("insert into user values(?,?,?,?,?,'"+strDateNew+"','Active')");
//ps.setString(1,uid);
ps.setString(1,x);
ps.setString(2,a);
ps.setString(3,b);
