    ...
    <div id="logo"> 
      ...
      <div style="position:absolute; left:36px;  top:80px;"> 
        <div align="left"><font color="#FFFFFF" size="4"><storng><b><h1>Identity-Based Encryption</h1>
            ...
            <div id="menu">
				<ul>
				<li class="current"><a href="tpa2.jsp"><b>GROUP MANAGER</b></a></li>
	  ...
	  style="text-decoration:underline">User Data</font></em></strong> <br/>
        ...
        <form name="s" action="admin_store11.jsp" method="get" onSubmit="return valid()">
          <table align="center" width="500">
            ...
            <tr>
              <td></td>
              <td><IMG src="images/arrow.gif" width="45" height="25"><a href="view.jsp"><b>VIEW TO NEXT DATA</b></a>&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Store"></td>
            </tr>
          </table>
        </form>
      </div>
