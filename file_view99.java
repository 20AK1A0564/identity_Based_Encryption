...
<body>
    ...
    <div id="logo"> 
      ...
      <div> 
        <div align="left"><font color="#FFFFFF" size="4"><storng><b>Group Data Sharing In Cloud Computing On Identity Based Encryption</b></strong></font> </div>
      </div>
    </div>
...
while(rs.next())
 ...
 %>
          <tr> 
            ...
            <td bgcolor="#CCFFFF"> <a href="view12345.jsp?file_name=<%=file_name%>">view</a> 
            </td>
